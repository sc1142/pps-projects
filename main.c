...
void cancel(int *array)
{
	  ...
	  for (i=0;i<300;i++)
	  {
	  		if(Cseat==person[i].id)
	  		{
					 stop=5;
					 system("cls");
					 printf("\n %s your seat %d is cancelled",person[i].name,person[i].seat);
...
void ticket1(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t------------------------INOX MOVIES---------------------\n");
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name : The Fault in Our Stars \n",id2);
        printf("\t Customer  : %s\n",name);
...
int movie(void)
{
	...
	printf("\t\t\tpress 1 for The Fault in Our Stars \n\n");
	printf("\t\t\tpress 2 for The Blood Red Sky \n\n");
	printf("\t\t\tpress 3 for Parasite \n");
	scanf("%d",&i);
	system("cls");
	return i;
}
void ticket2(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t----------------------INOX MOVIES-------------------\n");
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name : The Blood Red Sky\n",id2);
        printf("\t Customer  : %s\n",name);
...
void ticket3(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t----------------------INOX MOVIES-------------------\n");
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name : Parasite  \n",id2);
        printf("\t Customer  : %s\n",name);
        printf("\t\t\t                              Date      : 5-07-2022\n");
        printf("\t                                              Time      : 10:00pm\n");
        printf("\t                                              Hall      : 04\n");
        printf("\t                                              seats No. : %d  \n",choice);
        printf("\t                                              price.    : %d  \n\n",price);
